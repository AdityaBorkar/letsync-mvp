...
export type Server = ReturnType<typeof ServerConfig>
...
export function ServerConfig(config: LetsyncConfig) {
  ...
  const context: Context = { apiUrl, auth, connections: [], db, fs, pubsub }
